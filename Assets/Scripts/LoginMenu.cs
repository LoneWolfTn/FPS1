...
public class LoginMenu : MonoBehaviour
{
    ...
    { //called when the 'Login' button on the login part is pressed
        ...
        if (isDatabaseSetup == true)
        {
            ...
            UserAccountManager.instance.LogIn(input_login_username.text, "pass");
...
//                                //ready to send request
//                                StartCoroutine(sendRegisterRequest(input_register_username.text, input_register_password.text, "[Kill]0/[Death]0")); //calls function to send register request
//                                part = 3; //show 'loading...'
//                            }
